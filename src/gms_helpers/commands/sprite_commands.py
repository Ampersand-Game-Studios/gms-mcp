...
def handle_sprite_add_frame(args):
    ...
    result = add_frame(project_root, args.sprite_path, position=getattr(args, "position", -1), source_png=source_png)
...
def handle_sprite_remove_frame(args):
    ...
    result = remove_frame(project_root, args.sprite_path, args.position)
...
def handle_sprite_duplicate_frame(args):
    ...
    result = duplicate_frame(
        project_root, args.sprite_path, args.source_position, target_position=getattr(args, "target", -1)
    )
