...
class TestSwapSpriteFrame(TestSpriteMultiframeBase):
    ...
    def test_swap_first_frame(self):
        ...
        result = swap_sprite_png(self.project_root, sprite_path, test_png, frame_index=0)
    ...
    def test_swap_middle_frame(self):
        ...
        result = swap_sprite_png(self.project_root, sprite_path, test_png, frame_index=2)
    ...
    def test_swap_last_frame(self):
        ...
        result = swap_sprite_png(self.project_root, sprite_path, test_png, frame_index=3)
    ...
    def test_swap_invalid_frame_index(self):
        ...
        with self.assertRaises(ValueError) as ctx:
            swap_sprite_png(self.project_root, sprite_path, test_png, frame_index=5)
    ...
    def test_swap_negative_frame_index(self):
        ...
        with self.assertRaises(ValueError):
            swap_sprite_png(self.project_root, sprite_path, test_png, frame_index=-1)


class TestSpriteImport(TestSpriteMultiframeBase):
    """Test sprite strip import functionality."""

    def _create_test_strip(
        self, name: str, frame_count: int, frame_width: int, frame_height: int, layout: str = "horizontal"
    ):
    ...
    def test_import_horizontal_strip(self):
        ...
        result = import_strip_to_sprite(self.project_root, "spr_imported_h", strip_path, layout="horizontal")
    ...
    def test_import_vertical_strip(self):
        ...
        result = import_strip_to_sprite(self.project_root, "spr_imported_v", strip_path, layout="vertical")
    ...
    def test_import_with_explicit_dimensions(self):
        ...
        result = import_strip_to_sprite(
            self.project_root, "spr_explicit", strip_path, frame_width=64, frame_height=48, layout="horizontal"
        )
    ...
    def test_import_nonexistent_file_error(self):
        ...
        with self.assertRaises(FileNotFoundError):
            import_strip_to_sprite(self.project_root, "spr_nonexistent", Path("/nonexistent/file.png"))
