...
class TestScriptAsset(TestAssetsComprehensive):
    ...
    def test_script_create_files_integration(self):
        ...
        with patch("builtins.print"):  # Suppress print output
            relative_path = self.script_asset.create_files(self.project_root, "test_script", self.parent_path)
...
class TestObjectAsset(TestAssetsComprehensive):
    ...
    def test_object_create_yy_data_with_sprite(self):
        ...
        yy_data = self.object_asset.create_yy_data("o_test", self.parent_path, sprite_id="spr_test")
    ...
    def test_object_create_yy_data_with_parent_object(self):
        ...
        yy_data = self.object_asset.create_yy_data("o_child", self.parent_path, parent_object="o_parent")
    ...
    def test_object_parent_object_validation_rejects_paths(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.object_asset.create_yy_data("o_child", self.parent_path, parent_object="objects/o_actor/o_actor.yy")
        ...
        with self.assertRaises(ValueError) as context:
            self.object_asset.create_yy_data("o_child", self.parent_path, parent_object="objects/o_actor")
        self.assertIn("expects ONLY the object name", str(context.exception))
        ...
        with self.assertRaises(ValueError) as context:
            self.object_asset.create_yy_data("o_child", self.parent_path, parent_object="o_actor.yy")
        self.assertIn("expects ONLY the object name", str(context.exception))
    ...
    def test_object_create_yy_data_with_both_sprite_and_parent(self):
        ...
        yy_data = self.object_asset.create_yy_data(
            "o_complex", self.parent_path, sprite_id="spr_complex", parent_object="o_base"
        )
...
class TestSpriteAsset(TestAssetsComprehensive):
    ...
    def test_sprite_create_yy_data_custom_dimensions(self):
        ...
        yy_data = self.sprite_asset.create_yy_data("spr_custom", self.parent_path, width=128, height=256)
    ...
    def test_sprite_create_yy_data_frame_count(self):
        ...
        yy_data = self.sprite_asset.create_yy_data("spr_animated", self.parent_path, frame_count=5)
    ...
    def test_sprite_create_stub_files_custom_dimensions(self):
        ...
        self.sprite_asset.create_stub_files(asset_folder, "spr_custom", width=128, height=256)
...
class TestRoomAsset(TestAssetsComprehensive):
    ...
    def test_room_create_yy_data_custom_dimensions(self):
        ...
        yy_data = self.room_asset.create_yy_data("r_custom", self.parent_path, width=800, height=600)
...
class TestFolderAsset(TestAssetsComprehensive):
    ...
    def test_folder_create_yy_data_with_parent(self):
        ...
        yy_data = self.folder_asset.create_yy_data("SubFolder", parent_path="folders/ParentFolder.yy")
    ...
    def test_folder_create_files_integration(self):
        ...
        with patch("builtins.print"):  # Suppress print output
            relative_path = self.folder_asset.create_files(self.project_root, "TestFolder")
...
class TestFontAsset(TestAssetsComprehensive):
    ...
    def test_font_create_yy_data_custom_settings(self):
        ...
        yy_data = self.font_asset.create_yy_data(
            "fnt_custom", self.parent_path, font_name="Times New Roman", size=16, bold=False, italic=True
        )
...
class TestErrorConditions(TestAssetsComprehensive):
    ...
    def test_asset_creation_with_missing_directories(self):
        ...
        with patch("builtins.print"):  # Suppress print output
            ...
            relative_path = script_asset.create_files(self.project_root, "test_script", parent_path)
    ...
    def test_asset_creation_with_json_save_error(self):
        ...
        with patch(
            "gms_helpers.base_asset.save_pretty_json_gm", side_effect=PermissionError("Mocked permission error")
        ):
    ...
    def test_sprite_creation_with_negative_dimensions(self):
        ...
        yy_data = sprite_asset.create_yy_data("spr_test", parent_path, width=-10, height=-20)
    ...
    def test_object_creation_with_nonexistent_sprite(self):
        ...
        yy_data = object_asset.create_yy_data("o_test", parent_path, sprite_id="spr_nonexistent")
...
class TestAssetIntegrationScenarios(TestAssetsComprehensive):
    ...
    def test_multiple_asset_creation_sequence(self):
        ...
        object_asset = ObjectAsset()
        with patch("builtins.print"):
            object_path = object_asset.create_files(self.project_root, "o_player", parent_path, sprite_id="spr_player")

        # Create script for the object
        script_asset = ScriptAsset()
        with patch("builtins.print"):
            script_path = script_asset.create_files(self.project_root, "player_init", parent_path)
    ...
    def test_nested_folder_creation(self):
        ...
        with patch("builtins.print"):
            ...
            parent_path = folder_asset.create_files(self.project_root, "UI")

            # Create child folder
            child_path = folder_asset.create_files(self.project_root, "Buttons", parent_path=parent_path)
    ...
    def test_asset_creation_performance_stress(self):
        ...
        with patch("builtins.print"):  # Suppress output for performance
            ...
            for i in range(10):
                ...
                relative_path = script_asset.create_files(self.project_root, script_name, parent_path)
