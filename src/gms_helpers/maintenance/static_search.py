...
def find_string_references_in_gml(root_dir: str, config: Optional["NamingConfig"] = None) -> Dict[str, Set[str]]:
    """
...
def cross_reference_strings_to_files(
    string_refs: Dict[str, Set[str]], filesystem_files: Set[str], filesystem_map: Dict[str, str]
) -> Dict[str, List[str]]:
    """
        ...
        for ref in refs:
            ...
            if asset_type == "sprites":
                ...
                possible_paths.extend(
                    [f"sounds/{ref}/{ref}.yy", f"sounds/{ref}.wav", f"sounds/{ref}.mp3", f"sounds/{ref}.ogg"]
                )
