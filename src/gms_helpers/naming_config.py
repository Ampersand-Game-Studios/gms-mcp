...
def _get_factory_defaults() -> Dict[str, Any]:
    ...
    return {
        ...
        "linting": {"block_on_critical_errors": True, "require_inherited_event": True},
    }
...
def create_default_config_file(project_root: Union[str, Path], overwrite: bool = False) -> Path:
