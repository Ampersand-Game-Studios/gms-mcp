        ...
        with patch(
            ...
            cases = [
                (
                    ...
                    {
                        "name": "scr_test",
                        "parent_path": "folders/Scripts.yy",
                        "is_constructor": True,
                ...
                (
                    ...
                    {
                        "name": "o_player",
                        "sprite_id": "spr_player",
                        "parent_object": "o_parent",
                        "project_root": "/tmp/project",
                    },
                    "object",
                ),
                (
                    "gm_create_sprite",
                    {"name": "spr_player", "frame_count": 4, "project_root": "/tmp/project"},
                    "sprite",
                ),
                (
                    "gm_create_room",
                    {"name": "r_main", "width": 800, "height": 600, "project_root": "/tmp/project"},
                    "room",
                ),
                (
                    "gm_create_folder",
                    {"name": "Sprites", "path": "folders/Sprites.yy", "project_root": "/tmp/project"},
                    "folder",
                ),
                (
                    "gm_create_font",
                ...
                (
                    "gm_create_sound",
                    {"name": "snd_boom", "volume": 0.8, "pitch": 1.2, "bitrate": 192, "project_root": "/tmp/project"},
                    "sound",
                ),
                (
                    "gm_create_path",
                ...
                (
                    "gm_create_timeline",
                    {"name": "tl_intro", "parent_path": "folders/Timelines.yy", "project_root": "/tmp/project"},
                    "timeline",
                ),
                (
                    "gm_create_sequence",
                    {"name": "seq_intro", "length": 120.0, "playback_speed": 60.0, "project_root": "/tmp/project"},
                    "sequence",
                ),
    ...
    def test_maintenance_wrappers_forward_cli_args(self):
        with patch(
            ...
            cases = [
                (
                    "gm_maintenance_auto",
                    {"fix": False, "verbose": False, "project_root": "/tmp/project"},
                    ["maintenance", "auto", "--no-verbose"],
                ),
                ...
                (
                    ...
                    {"dry_run": True, "project_root": "/tmp/project"},
                    ["maintenance", "prune-missing", "--dry-run"],
                ),
                (
                    "gm_maintenance_validate_paths",
                    {"strict_disk_check": True, "include_parent_folders": True, "project_root": "/tmp/project"},
                    ["maintenance", "validate-paths", "--strict-disk-check", "--include-parent-folders"],
                ),
                (
                    "gm_maintenance_dedupe_resources",
                    {"auto": True, "dry_run": True, "project_root": "/tmp/project"},
                    ["maintenance", "dedupe-resources", "--auto", "--dry-run"],
                ),
                (
                    "gm_maintenance_sync_events",
                    {"fix": False, "object": "o_player", "project_root": "/tmp/project"},
                ...
                (
                    ...
                    {"delete": False, "skip_types": ["font", "sound"], "project_root": "/tmp/project"},
                    ["maintenance", "clean-orphans", "--skip-types", "font", "sound"],
                ),
            ]
        ...
        with patch(
            ...
            cases = [
                (
                    ...
                    {"source_room": "r_old", "new_name": "r_new", "project_root": "/tmp/project"},
                    ["room", "ops", "duplicate", "r_old", "r_new"],
                ),
                (
                    "gm_room_ops_rename",
                    {"room_name": "r_old", "new_name": "r_new", "project_root": "/tmp/project"},
                    ["room", "ops", "rename", "r_old", "r_new"],
                ),
                (
                    "gm_room_ops_delete",
                    {"room_name": "r_old", "dry_run": True, "project_root": "/tmp/project"},
                    ["room", "ops", "delete", "r_old", "--dry-run"],
                ),
                (
                    "gm_room_ops_list",
                    {"verbose": True, "project_root": "/tmp/project"},
                    ["room", "ops", "list", "--verbose"],
                ),
                (
                    "gm_room_layer_add",
                    {
                    ...
                    ["room", "layer", "add", "r_main", "instance", "Actors", "--depth", "100"],
                ),
                (
                    "gm_room_layer_remove",
                    {"room_name": "r_main", "layer_name": "Actors", "project_root": "/tmp/project"},
                    ["room", "layer", "remove", "r_main", "Actors"],
                ),
                (
                    "gm_room_layer_list",
                    {"room_name": "r_main", "project_root": "/tmp/project"},
                    ["room", "layer", "list", "r_main"],
                ),
                (
                    ...
                    ["room", "instance", "add", "r_main", "o_player", "10", "20", "--layer", "Actors"],
                ),
                (
                    "gm_room_instance_remove",
                    {"room_name": "r_main", "instance_id": "inst_1", "project_root": "/tmp/project"},
                    ["room", "instance", "remove", "r_main", "inst_1"],
                ),
                (
                    "gm_room_instance_list",
                    {"room_name": "r_main", "project_root": "/tmp/project"},
                    ["room", "instance", "list", "r_main"],
                ),
            ]
    ...
    def test_texture_group_direct_wrappers_set_project_metadata(self):
        ...
        success_cases = [
            ...
            (
                ...
                {
                    "group_name": "game",
                    "asset_identifiers": ["sprites/spr_test/spr_test.yy"],
                    "dry_run": True,
                    "project_root": "/tmp/project",
                },
        ...
        with patch("gms_mcp.server.tools.texture_groups._requires_dry_run_for_tool", return_value=True):
            for tool_name, kwargs in [
                ...
                (
                    "gm_texture_group_rename",
                    {"old_name": "old", "new_name": "new", "dry_run": False, "project_root": "/tmp/project"},
                ),
        ...
        with patch(
            ...
            cases = [
                (
                    ...
                    ["workflow", "duplicate", "scripts/scr_old/scr_old.yy", "scr_new", "--yes"],
                ),
                (
                    "gm_workflow_rename",
                    {"asset_path": "scripts/scr_old/scr_old.yy", "new_name": "scr_new", "project_root": "/tmp/project"},
                ...
                (
                    ...
                    ["workflow", "swap-sprite", "sprites/spr_test/spr_test.yy", "frame.png", "--frame", "2"],
                ),
                (
                    "gm_sprite_add_frame",
                    {
                        "sprite_path": "sprites/spr_test/spr_test.yy",
                        "position": 2,
                        "source_png": "frame.png",
                        "project_root": "/tmp/project",
                    },
                    [
                        "sprite-frames",
                        "add",
                        "sprites/spr_test/spr_test.yy",
                        "--position",
                        "2",
                        "--source",
                        "frame.png",
                ...
                (
                    ...
                    {"sprite_path": "sprites/spr_test/spr_test.yy", "position": 1, "project_root": "/tmp/project"},
                    ["sprite-frames", "remove", "sprites/spr_test/spr_test.yy", "1"],
                ),
                (
                    ...
                    ["sprite-frames", "duplicate", "sprites/spr_test/spr_test.yy", "0", "--target", "3"],
                ),
                (
                ...
                (
                    ...
                    {"sprite_path": "sprites/spr_test/spr_test.yy", "project_root": "/tmp/project"},
                    ["sprite-frames", "count", "sprites/spr_test/spr_test.yy"],
                ),
            ]
