...
from gms_helpers.room_helper import duplicate_room, rename_room, delete_room, list_rooms, main
...
class TestRoomOperations(unittest.TestCase):
    ...
    @patch("gms_helpers.room_helper.delete_asset")
    def test_delete_room_rejects_room_name_path_traversal(self, mock_del):
        """Room delete must not pass traversal paths to asset deletion."""
        result = delete_room("../../victim")
